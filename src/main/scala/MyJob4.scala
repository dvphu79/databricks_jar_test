...
object MyJob4 {
  def main(args: Array[String]): Unit = {
    ...
    uploadTransformedDataToSynapseTable(mergeSeqDf, tableName, containerName, storageAccountName, directoryName)
  ...
  private def uploadTransformedDataToSynapseTable(df: DataFrame, tableName: String, containerName: String, storageAccountName: String, directoryName: String): Unit = {
